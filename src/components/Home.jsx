...
function Home() {
  return (
    <div name='home' className='w-full h-screen bg-gradient-to-r from-gray-700 via-gray-900 to-black'>
      {/* container */}
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <div>
          <button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#c33c54] hover:border-[#c33c54]'>
