...
function Contact() {
  return (
    <div name='contact' className='w-full max-h-[500px] h-screen bg-gradient-to-r from-gray-700 via-gray-900 to-black flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/aa2bf1cb-6943-4ad6-ac75-aecff2abf3bc" className='flex flex-col max-w-[800px] w-full h-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-[#c33c54] text-[#EEF5DB]'>Contact</p>
                <p className='text-[#EEF5DB] py-4'>Submit the form belor or shot me an email - brlisbo@gmail.com</p>
            </div>
